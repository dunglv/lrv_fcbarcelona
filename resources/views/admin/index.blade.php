...
<html>
  <head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="{{URL::to('/')}}/css/custom-lte.css">
  </head>
    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini">{!!HTML::image('/images/site/fc-icon.png')!!}</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">{!!HTML::image('/images/site/fc-icon.png')!!}</span>
        </a>
...
<ul class="sidebar-menu">
  ...
  <li class="treeview">
    ...
    <ul class="treeview-menu">
      ...
      <li ><a href="index.html"><i class="fa fa-circle-o"></i> Article</a></li>
      <li><a href="index.html"><i class="fa fa-circle-o"></i> Categories</a></li>
    </ul>
  </li>
  <li class="active treeview">
    <a href="#">
      <i class="fa fa-paperclip"></i><span> Article</span>
      <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
      </span>
    </a>
    <ul class="treeview-menu">
      <li class="active"><a href="{{route('admin.article.create')}}"><i class="fa fa-pencil-square-o"></i> Create new</a></li>
      <li ><a href="index.html"><i class="fa fa-paragraph"></i> All Articles</a></li>
      <li><a href="index.html"><i class="fa fa-trash"></i> Trash</a></li>
    </ul>
  </li>
    <li class="treeview">
    <a href="#">
      <i class="fa fa-paperclip"></i><span> Categories</span>
      <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
      </span>
    </a>
    <ul class="treeview-menu">
      <li class="active"><a href="index.html"><i class="fa fa-pencil-square-o"></i> Create new</a></li>
      <li ><a href="index.html"><i class="fa fa-paragraph"></i> All Categories</a></li>
      <li><a href="index.html"><i class="fa fa-trash"></i> Trash</a></li>
    </ul>
  </li>
  <li class="treeview">
